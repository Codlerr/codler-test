 export const services=[
    ...
    export const Digital=[{
        ...
        {
        fontcolor:'white',
        description:'Led by the expert team of CA and IT professionals, Krijay Technologies is one of the best SAP Business One Partners in Hyderabad known for its trusted business automation services for small to medium-sized enterprises.',
