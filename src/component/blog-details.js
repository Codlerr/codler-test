                ...
                <div className='grid grid-cols-1 lg:grid-cols-4'>
                    <div className='col-span-3 text-white'>
                        <div className=''>
                            ...
                            <p className='text-2xl lg:text-4xl font-bold text-white pt-2'>Designing for a drone automation system</p>
                            <p className='text-xs lg:text-xs text-white pt-2'>This is a design assignment I did while looking for an internship.I had to finish and submit the assignment within 48 hours with <br/>all the requirements.Everything below is exactly how i submitted the assignment.</p>
                        ...
                        <div className='pt-20' data-aos="fade-up">
                            ...
                            <p className='lg:w-4/5 text-sm lg:text-sm font-italic text-zinc-300'>To solve the pressing issue of security & surveillance at the museum, by designing a web-based application that would control all drone fleet operations.</p>
                        </div>

                        <div className='pt-10' data-aos="fade-up">
                            <p className='lg:text-2xl font-semibold'>Understanding the product</p>
                            <p className='lg:w-4/5 text-sm lg:text-sm font-light text-zinc-300'>Before starting, let us understand the product at hand. It is necessary to have a good understanding of the technology, how it works, problems with current products, etc. to provide a solution that works towards improving the user experience.Let us answer some basic questions first-</p>
                        </div>
                        ...
                        <div className='pt-10' data-aos="fade-up">
                            ...
                            <p className='lg:w-4/5 text-sm lg:text-sm font-light pt-2 text-zinc-300' > A stand-alone drone-in-a-box system has 3 main components:
