        ...
        <div>
            <section className='main-content'>
                <div className='w-10/12 mx-auto grid grid-cols-1 lg:grid-cols-2  pt-40' data-aos="fade-up">
                    <div>
                    <p className="text-white text-3xl lg:text-4xl md:pt-16 md:mt-5 font-bold" data-aos="fade-right" data-aos-delay="200" >Want to know more<br></br> about<span className='pl-2 textlbg'>codler</span></p>
                        <p className="lg:text-lg tracking-wider  text-xs tracking-tight  lg:w-2/3  text-zinc-200">We are the perfect professional team of designers and developers for you. Codler is a top website and mobile app development
                   company. In addition to empower our client sincerely by developinfg full customized mobile and web-based digital solution is our mission.</p>
                        ...
                        <a href='#'><img src={'https://res.cloudinary.com/dbwyrrrqo/image/upload/v1648585515/codler/arrw_aof6aj.png'} className='h-20 my-10 lg:my-0 lg:mt-16'></img></a>
                        </div>
                    </div>

                    <div>
                        <img src={'https://res.cloudinary.com/dbwyrrrqo/image/upload/v1648585635/codler/officework_bbpbsv.jpg'} className='rounded-lg pt-16 md:pt-0 md:mt-16 lg:mt-10  lg:pt-0 lg:h-80 lg:w-[500px] lg:ml-14'></img>
                        <img src='https://res.cloudinary.com/dbwyrrrqo/image/upload/v1648585628/codler/bubble2_nkoawf.png' alt='img' className='w-24 h-24 ml-[98%] -mt-5 hidden lg:block'/>
                    ...
                    <div className='w-10/12 lg:w-8/12 mx-auto'>
                        <div className='grid grid-cols-1 lg:grid-cols-2 py-20'>
                            ...
                            <p className="text-4xl text-white font-bold">WE are experts with</p>
                                    <ul className="">
                                        <li className="text-3xl list-disc text-pink-800  mt-3"><div className="text-zinc-300 font-semibold text-base">Innovative emphasis.</div></li>
                            ...
                            <div>
                                <img src={'https://res.cloudinary.com/dbwyrrrqo/image/upload/v1649503993/codler/creative-business-team-discussing-over-the-laptop-2021-08-28-18-10-11-utc_1_v46o3a.png'} className='absolute h-96 w-96 xl:ml-24 -mt-40 hidden lg:block'  data-aos="fade-up" style={{width:'500px'}}></img>
                            </div>
                        </div>
                    </div>

                    <div className='  md:mx-64 pb-20' data-aos="fade-up">
            ...
            <section className='w-10/12 mx-auto bg-gradient-to-r from-zinc-900 via-zinc-800 to-zinc-900 rounded-xl' data-aos="zoom-in">
                <div className='w-10/12 mx-auto py-10'>
                    <div>
                        <p className='text-white text-base font-semibold leading-7'>We proudly work with</p>
                    ...
                    <div className='col-span-2'>
                        <div className='grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-2 gap-y-8 lg:gap-y-14' >
                            <div data-aos="fade-up">
                                ...
                                <p  className='text-zinc-400 pl-14 text-sm lg:px-16  font-normal tracking-normal font-light'>Specifically having satisfied clients accounts for our success. It is a core part of our strategy. This kind of praise is pure bliss to us, so that we'd like to hear it more often. It's a never-ending desire in us - it's built-in to our DNA.</p>
                            </div>
                            <div data-aos="fade-up">
                                <div className='flex'>
                            ...
                            <div data-aos="fade-up">
                                ...
                                <p className='text-zinc-400 pl-12 md:pl-10 text-sm lg:px-16 font-light tracking-normal'>Integrity is at the heart of everything we do, and it is the foundation of our work. It's about keeping our promises, being honest and fair in business and everyday life in particular.</p>
                            </div>
                            <div data-aos="fade-up">
                                <div className='flex'>
                                ...
                                <p className='text-zinc-400 pl-12  text-sm lg:px-12   font-light tracking-normal'>All that Codlerr has to offer includes promises, global recognitions, and testaments. Besides, we value the variety of opinions, cultures, and people with the utmost respect. </p>
                            </div>
                        </div>
                    </div>
                </div>
