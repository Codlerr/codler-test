            ...
            <img src={shade} className='pt-60 lg:pt-12 blur-xl  lg:blur-lg z-0 absolute' data-aos="zoom-in"></img>
                <div className='w-10/12 mx-auto xl:mx-20 grid grid-cols-1 lg:grid-cols-2 blur-0 lg:pb-32'>
                    <div className='pt-52 lg:pt-48' data-aos="fade-up">
                        <p className='text-white text-2xl md:mt-5 lg:text-4xl font-bold'>Car Chilli</p>
                    ...
                    <div className='w-10/12 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 py-16'>
                        <div className='text-white'>
                            ...
                            <div data-aos="fade-up">
                                <p className='lg:w-4/5 text-sm lg:text-base text-zinc-300'> </p>
                                <p className='lg:w-4/5 text-sm lg:text-base text-zinc-300'>A car rental mobile app based in Singapore where a user and the owner are at benefit.  </p>
                            </div>
                        </div>

                        <div className=' flex justify-center lg:py-20' data-aos="fade-up">
                            <img src={'https://res.cloudinary.com/dbwyrrrqo/image/upload/v1654512828/codler/car_chilly_au9rkh.png'} className='w-36'></img>
                        </div>
                    </div>
            </section>

            <section className='bg-center bg-cover mb-3 h-[70vh] bg-[url(https://res.cloudinary.com/dbwyrrrqo/image/upload/v1655181747/codler/Web_Site_Image_Rent_Car_1_y3b7k1.jpg)]'>
                ...
                <div className='w-10/12 mx-auto py-20 text-white' data-aos="fade-up">
                    ...
                    <p className='lg:w-2/4 text-zinc-300'>Firstly, we had to create a logo that connected with the inspiration behind the name Car Chilli then, we had to work on creating a better customer experience in the app that helps users to rent a car easily and lastly create a design by adding features that stand out as initially they were just an essential app.</p>
                </div>
            ...
            <section className='w-10/12 mx-auto pt-32 lg:pt-0'>
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                        ...
                        <div className='lg:py-32 lg:px-10' data-aos="fade-up">
                            ...
                            <p className='text-white text-sm lg:text-base pb-8'>As a startup Car Chilli needed to establish itself as a brand from the ground up. Our team got to work right away, developing a logo, brand guidelines, and an application for the brand.We had the opportunity to do the branding, logo development, App design and App development.</p>
            ...
            <section className='w-10/12 mx-auto pt-24 lg:pt-0 lg:-mt-14 pb-10'>
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                        <div className='lg:py-32 lg:px-10' data-aos="fade-up">
                            ...
                            <p className='text-white text-sm lg:text-base pb-8'>A change in the UI design from a basic structure to a better UI that interacts with the customers—researched how the app should be, and took another step in changing the LOGO. In addition, we changed it with a better color coordination and user interface that makes the app a very user-friendly app for the customers.</p>
                        </div>
                        <div className=' flex justify-center p-5' data-aos="fade-up">
...
export default PortfolioCarchilli;