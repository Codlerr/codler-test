          ...
          <section>
            <img src={shade} className='pt-60 lg:pt-12 blur-xl  lg:blur-lg z-0 absolute' data-aos="zoom-in"></img>
                <div className='w-10/12 mx-auto xl:mx-20 grid grid-cols-1 lg:grid-cols-2 blur-0 lg:pb-32'>
                    <div className='pt-52 lg:pt-48' data-aos="fade-up">
                        <p className='text-white text-2xl md:mt-5 lg:text-4xl font-bold'>Krijay</p>
                    ...
                    <div className='w-10/12 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 py-16'>
                        <div className='text-white'>
                            ...
                            <div data-aos="fade-up">
                                <p className='lg:w-4/5 text-sm lg:text-base text-zinc-300'>Krijay is an IT company based in Hyderabad, led by a core team of qualified and experienced Chartered Acco</p>
                        ...
                        <div className=' flex justify-center lg:py-20' data-aos="fade-up">
                            <img src={'https://res.cloudinary.com/dbwyrrrqo/image/upload/v1654242042/codler/jsk1_1_lxtej9.png'} className=''></img>
                        </div>
                    </div>
            </section>
            ...
            <section className='port-sec3-bg'>
                ...
                <div className='w-10/12 mx-auto py-20 text-white' data-aos="fade-up">
                    ...
                    <p className='lg:w-2/4 text-zinc-300'>Our role was to increase their social media presence, create SEO-based content for websites, create creative copies for social media marketing, design creative graphics for social media marketing, and design and develop websites. </p>
                </div>
            ...
            <section className='w-10/12 mx-auto pt-32 lg:pt-0'>
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                        ...
                        <div className='lg:py-32 lg:px-10' data-aos="fade-up">
                            ...
                            <p className='text-white text-sm lg:text-base pb-8'>We had the opportunity to perform Website Designing, Website Development, Digital Marketing, SEO, Copywriting, and User Experience </p>
            ...
            <section className='w-10/12 mx-auto pt-24 lg:pt-0 lg:-mt-14 pb-10'>
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                        <div className='lg:py-32 lg:px-10' data-aos="fade-up">
                            ...
                            <p className='text-white text-sm lg:text-base pb-8'>In order to design a stellar website, we started by building a solid understanding of Krijay’s business, competitors, customers, website pain points, and business goals. As a result, we came up with a unique website for Krijay with engaging content on their social media platforms to increase their social media presence.</p>
                        </div>
                        <div className=' flex justify-center p-5' data-aos="fade-up">
...
export default PortfolioKrijay;
