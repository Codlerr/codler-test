            ...
            <section className=' w-10/12 sm:ml-4 md:ml-20 pb-20'>
                <div className='grid grid-cols-1 lg:grid-cols-2'>
                    ...
                    <div className=' hidden lg:block'>
                        <img src='https://res.cloudinary.com/dbwyrrrqo/image/upload/v1652779631/codler/Group_790_gnmokn.png' alt='img' className='w-36 h-36 mt-36 lg:ml-16 xl:ml-36 z-200 relative hidden lg:block'/>
                        <img data-aos="fade-up" src={'https://res.cloudinary.com/dbwyrrrqo/image/upload/v1653318345/codler/circlelogo_rsbt3x.png'} className='h-64 w-64 relative -z-200 ml-[78%] lg:-mt-36 xl:-mt-48 right-60'></img>
                        <p data-aos="fade-up"  className="text-l hidden   absolute xl:right-48  -mt-10 hidden xl:block  font-bold opacity-30 text-lg text-zinc-700" >Backend</p>
                        <p data-aos="fade-up"  className="text-l hidden   absolute xl:right-96 -mt-10 hidden xl:block pr-24  font-bold opacity-30 text-lg text-zinc-700" >Database</p>
                        <p data-aos="fade-up"  className="text-l hidden  absolute xl:right-56 top-28 hidden xl:block  font-bold opacity-30  text-lg text-zinc-700" >CMS</p>
                        <p data-aos="fade-up"  className="text-l hidden  absolute xl:right-96 top-28 pr-24 hidden xl:block  font-bold opacity-30  text-lg  text-zinc-700" >Mobile</p>
                        <p data-aos="fade-up"  className="text-l hidden  absolute xl:right-36 top-48 font-bold opacity-30 hidden xl:block text-lg text-zinc-700" >Database</p>
                        <p data-aos="fade-up"  className="text-l hidden  absolute right-96 top-48 pr-36  font-bold hidden xl:block opacity-30 text-lg text-zinc-700" >Infra & devops</p>
            ...
            <section className=' z-200 relative bg-zinc-800 ' >
                <div className='py-12 bg-zinc-800'>
                    <div className=' w-10/12 mx-auto grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-3 gap-x-6 gap-y-8'>
                        <div data-aos="fade-up" className='bg-zinc-700 hover:bg-gradient-to-r from-purple-500 to-fuchsia-700 rounded-md px-10 lg:pl-10 cursor-pointer' onClick={() => navigate('/technology/onclickmobile')}>
                        ...
                        <div data-aos="fade-up" className='bg-zinc-700 rounded-md px-10 lg:pl-10 ' >
