            ...
            <section className='w-10/12 sm:ml-4 md:ml-20 pb-20'>
                <div className='grid grid-cols-1 lg:grid-cols-2'>
                    <div className='pt-40' data-aos="fade-up">
                        ...
                        <p className='lg:text-lg text-sm text-zinc-300  tracking-tight lg:text-left lg:w-3/4'>A variety of software development tools and technologies are used to develop resilient solutions customised to our customers' businesses.</p>
                    </div>
            ...
            <section className='bg-zinc-900 py-16'>
                    <div className='w-10/12 mx-auto grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-3 gap-x-6 gap-y-8'>
                        <div data-aos="fade-up" className='bg-gradient-to-r from-purple-500 to-fuchsia-700 rounded-md px-10 lg:pl-10 cursor-pointer' onClick={() => navigate('./onclickmobile')}>
                            ...
                            <p className='text-zinc-300 pb-2 lg:w-4/5 text-sm lg:text-base'>Resources with average experience of 5 years and tech expertise across the domains of native iOS, Android, cross platform, and hybrid apps.</p>
                        </div>
                        <div data-aos="fade-up" className='bg-zinc-700 rounded-md px-10 lg:pl-10 cursor-pointer' onClick={() => navigate('./onclickmobile')}>
                            ...
                            <p className='text-zinc-400 pb-2 lg:w-4/5 text-sm lg:text-base'>Delivering visually appealing, interactive, smooth, user-friendly, and high performing front ends with our 22+ years of industry experience.</p>
                        </div>
                        <div data-aos="fade-up" className='bg-zinc-700 rounded-md px-10 lg:pl-10 cursor-pointer' onClick={() => navigate('./onclickmobile')}>
                            <img src={svg3} className='h-16 -mt-3'></img>
                            <p className='text-white lg:text-xl font-semibold pt-3'>Backend</p>
                            <p className='text-zinc-400 pb-2 lg:w-4/5 text-sm lg:text-base'>Great importance to backend is essential for a successful software and our expertise in Java, NodeJS, .NET, PHP, Python, etc. help you achieve it.</p>
                        </div>
                        <div data-aos="fade-up" className='bg-zinc-700 rounded-md px-10 lg:pl-10 cursor-pointer' onClick={() => navigate('./onclickmobile')}>
                            <img src={svg4} className='h-16 -mt-3'></img>
                            <p className='text-white lg:text-xl font-semibold pt-3'>Database</p>
                            <p className='text-zinc-400 pb-2 lg:w-4/5 text-sm lg:text-base'>Our expertise in multiple database technologies helps you to find the perfect fit for your project based on the requirements and user base.</p>
                        </div>
                        <div data-aos="fade-up" className='bg-zinc-700 rounded-md px-10 lg:pl-10 cursor-pointer' onClick={() => navigate('./onclickmobile')}>
                            <img src={svg5} className='h-16 -mt-3'></img>
                            <p className='text-white lg:text-xl font-semibold pt-3'>Infra and DevOps</p>
                            <p className='text-zinc-400 pb-2 lg:w-4/5 text-sm lg:text-base cursor-pointer'>We help you transform your business with automating infrastructure, software development and deployment processes using various DevOps tools.</p>
                        </div>
                        <div data-aos="fade-up" className='bg-zinc-700 rounded-md px-10 lg:pl-10 cursor-pointer' onClick={() => navigate('./onclickmobile')}>
                            <img src={svg6} className='h-16 -mt-3'></img>
                            <p className='text-white lg:text-xl font-semibold pt-3'>CMS</p>
                            <p className='text-zinc-400 pb-2 lg:w-4/5 text-sm lg:text-base'>Our hands-on experience with popular CMS tools helps enterprises to create and manage their digital content with greater flexibility and ease.</p>
                        </div>
                    </div>
            </section>
