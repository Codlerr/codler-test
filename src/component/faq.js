           ...
           <Helmet>
            ...
            <img src={drop2} className='absolute hidden lg:block right-0 h-40 mt-80' data-aos="fade-up"></img>
                <div className='w-9/12 lg:w-8/12 mx-auto  py-10'>
                    ...
                    <p className='text-zinc-400 lg:w-4/5 -mt-1 text-xs font-gilroyregular lg:text-base'>Since 2021, we've been a top software development IT company based in Bangalore, India. We have a fantastic staff of around 200 people who are extraordinary.</p>
                    ...
                    <p className='text-zinc-400 lg:w-4/5 -mt-1 text-xs font-gilroyregular  lg:text-base'>We do, in fact. After the project is done, you may request an extension of our project support. However, the cost varies from project to project. You can inquire about this once the project's size and scope have been determined.</p>
                    <hr class="my-4 w-[80%] text-zinc-200"/>
                    </div>
            ...
            <img src={drop1} className='absolute hidden lg:block left-0 h-40 mt-96' data-aos="fade-up"></img>
                    ...
                    <img src={h2} className='w-40 lg:w-56'  data-aos="fade-up"></img>
                        ...
                        <p className='text-white font-semibold font-gilroyregular lg:text-[22px]'>How long does it take you to design a website on average?</p>
                        <p className='text-zinc-400 lg:w-4/5 text-xs -mt-1 font-gilroyregular lg:text-base'>The total time it takes to build a website is determined by a number of factors. A static website often takes less time to design than an e-commerce or flash-based website. Complex websites, such as eCommerce websites, take a little longer due to their level of difficulty.</p>
                        <hr class="my-4 w-[80%] text-zinc-200"/>
                        </div>

                        <div className='' data-aos="fade-up">
                        <p className='text-white font-semibold font-gilroyregular lg:text-[22px]'>What’s your USP as a web development company?</p>
                        ...
                        <p className='text-zinc-400 lg:w-4/5 text-xs  -mt-1 font-gilroyregular lg:text-base'>Hire web developers from Codlerr who have experience with the newest HTML5 technologies. It's called responsive web design. We create visually appealing and aesthetically compelling site designs that work on both desktop and mobile platforms. However, you may need to include this in your objectives before beginning a website or app development project.</p>
                        <hr class="my-4 w-[80%] text-zinc-200"/>
                        </div>
                        ...
                        <p className='text-zinc-400 lg:w-4/5 text-xs  -mt-1 font-gilroyregular lg:text-base'>Yes, we always provide choices. We also specify our clients, to be precise about their requirements and website aspects. We offer a few choices based on that. As a result, this saves time and money as well as speeds up the web development process.</p>
                        <hr class="my-4 w-[80%] text-zinc-200"/>
                        </div>

                        <div className='' data-aos="fade-up">
                        <p className='text-white font-semibold font-gilroyregular lg:text-[22px]'>Do you have any websites that are similar to one I built earlier?</p>
            ...
            <section className='bg-zinc-900'>
                ...
                <img src={h3} className='w-40 lg:w-56'  data-aos="fade-up"></img>
                    <div className='pt-6' data-aos="fade-up">
                        ...
                        <p className='text-zinc-400 lg:w-4/5 text-xs -mt-1 font-gilroyregular lg:text-base'>A native app runs on only one platform (e.g. iOS, Android, Windows Phone). Web-based apps are virtual web pages that operate within the mobile browser. They provide the same user experience across all handsets, but can't access some device functionalities.</p>
                        <hr class="my-4 w-[80%] text-zinc-200"/>
                    </div>

                    <div className='' data-aos="fade-up">
                        <p className='text-white font-semibold font-gilroyregular lg:text-[22px]'>Do you create cross-platform mobile apps?</p>
                        <p className='text-zinc-400 lg:w-4/5 text-xs -mt-1 font-gilroyregular lg:text-base'>Yes, we produce mobile apps for all of the main mobile platforms. We can help you design apps for either one or two platforms, or an app that operates across all mobile devices.</p>
                        <hr class="my-4 w-[80%] text-zinc-200"/>
                    </div>
                    ...
                    <div className='' data-aos="fade-up">
                        ...
                        <p className='text-zinc-400 w-[80%] lg:w-4/5 text-xs -mt-1 font-gilroyregular lg:text-base'>Well, it all depends on how overwhelming your app concept is, as well as the app as a whole. At the same time having a strong concept will successively boost your chances of promotion.</p>
            ...
            <section className='bg-black mb-5'>
                    ...
                    <img src={h4} className='w-40 lg:w-56'  data-aos="fade-up"></img>
                        ...
                        <div className=''  data-aos="fade-up">
                            <p className='text-white font-semibold font-gilroyregular lg:text-[22px]'>Is your team fully relying on the customer to deliver all<br></br> information during execution?</p>
                            <p className='text-zinc-400 lg:w-4/5 text-xs -mt-1 font-gilroyregular lg:text-base'>No. When expectations are set early on in an engagement, they are easier to fulfill over time. Communication at the right time is the best way to avoid surprises. Investing in our team's long-term development and treating them like our own will improve your performance.</p>
                            <hr class="my-4 w-[80%] text-zinc-200"/>
                        </div>

                        <div className=''  data-aos="fade-up">
                            <p className='text-white font-semibold font-gilroyregular lg:text-[22px]'>Will you provide a quote over the phone?</p>
                            <p className='text-zinc-400 lg:w-4/5 text-xs -mt-1 font-gilroyregular lg:text-base'>In terms of quantity, price is not abstract. But, as you might imagine, it's not only about the price and quote. Pricing is affected by a lot of aspects, the most important of which is the solution we must create and team's setup etc. </p>
                            <hr class="my-4 w-[80%] text-zinc-200"/>
                        </div>
