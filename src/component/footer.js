           ...
           <div>
                <section>
                        <div className='lg:w-10/12 p-10 md:p-0  mx-auto md:pb-32 overflow:hidden'>
                            ...
                            <div className='footerbg -mt-10 lg:rounded-lg'>
                 ...
                 <footer className='w-10/12 mx-auto p-10 md:p-0 md:pb-24 pb-10'>
                     <div className='grid grid-cols-1 lg:grid-cols-4 gap-4'>
                            <div  className=''>
                                ...
                                <div>
                                    ...
                                    <a href='#' onClick={() => navigate('/services')} className='text-zinc-600 lg:text-sm hover:text-zinc-400 duration-500 tracking-wide no-underline'><p className=''>Services</p></a>
                                    <a href='#' onClick={() => navigate('/portfolio')} className='text-zinc-600 lg:text-sm hover:text-zinc-400 duration-500 tracking-wide no-underline'><p className=''>Portfolio</p></a>
                                    <a href='#' onClick={() => navigate('/Contactus')} className='text-zinc-600 lg:text-sm hover:text-zinc-400 duration-500 tracking-wide no-underline'><p className=''>Contact us</p></a>
                                </div>
                            </div>
                            <div  className=''>
                                ...
                                <div>
                                    ...
                                    <a href='#' className='text-zinc-600 lg:text-sm hover:text-zinc-400 duration-500 tracking-wide no-underline'><p className=''><span className='pr-4'><i class="fa-brands fa-facebook-square"></i></span>Facebook</p></a>
                                    <a href='#' className='text-zinc-600 lg:text-sm hover:text-zinc-400 duration-500 tracking-wide no-underline'><p className=''><span className='pr-4'><i class="fa-brands fa-youtube"></i></span>Youtube</p></a>
                                    <a href='#' className='text-zinc-600 lg:text-sm hover:text-zinc-400 duration-500 tracking-wide no-underline'><p className=''><span className='pr-4'><i class="fa-brands fa-twitter"></i></span>Twitter</p></a>
                                </div>
                            </div>
                            <div className=''>
